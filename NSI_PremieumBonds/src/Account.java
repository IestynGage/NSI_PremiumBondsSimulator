...
public class Account implements Comparable<Account> {
     ...
     *
     * @param Bonds the amount of bonds the account starts with
     */
    Account(int Bonds){
        premiumBonds = Bonds;
        startingAmount = Bonds;
        year = 0;
    }
    ...
    /**
     * Runs runLottery cmd 12 times adds 1 to year and then calculates AER
     */
    public void runYear(){
        for(int i =0; i<=12; i++){
            runLottery();
    ...
    /**
     * calls runBond cmd for each bond there is
     */
